...
class PostDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('visibility', function ($post) {
                return $post->visibilityType();
            })
            ...
            ->editColumn('title', function ($post) {
                return Str::limit($post->title, 30) . '<hr> <span class="red">Category | </span> ' . Str::limit($post->category->name, 30);
            })
            ->editColumn('descrption', function ($post) {
                return Str::limit($post->descrption, 100);
            })

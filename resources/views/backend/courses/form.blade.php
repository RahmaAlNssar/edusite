...
<div class="form-group">
    ...
    <div class="input-group">
        <textarea class="form-control" id="description" name="description" rows="2"
            placeholder="Course Descrption">{{$course->descrption ?? old('descrption')}}</textarea>
        {{-- END COURSE TEXTAREA --}}
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input type="number" class="form-control" name="discount"
                    value="{{ $course->discount ?? old('discount') }}" placeholder="Category Order" value="1" min="1">
            </div>
            ...
            <div class="input-group">
                ...
                <select class="form-control" name="category_id">
                    ...
                    <option value="{{$category->id}}"
                        {{isset($course) ? ($course->category_id == $category->id ? 'selected':'') : (old('category_id') == $category->id ? 'selected':'')}}>
